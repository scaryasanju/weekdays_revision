...
#     option("header", "true").csv("/Volumes/workspace/default/data_df/employee.txt")
employeeDF=spark.read.format("txt").load("/Volumes/workspace/default/data_df/employee.txt")
